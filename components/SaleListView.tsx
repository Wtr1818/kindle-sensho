    ...
    <div>
      <div className="mb-6 flex flex-wrap items-center gap-2">
        <button
          ...
          className={
            activeGenre === null
              ? "border border-[#000000] bg-[#000000] px-3 py-1.5 text-xs font-medium text-[#ffffff]"
              : "border border-[#000000]/20 px-3 py-1.5 text-xs font-medium text-[#000000]/60 hover:border-[#000000]/40"
          }
        >
          すべて
        </button>
