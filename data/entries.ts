...
export const entries: Entry[] = [
  ...
  },
  {
    ...
    contentType: "本",
    genre: "古典",
    hook: "小学校低学年で母から手渡された一冊。『君の膵臓をたべたい』の住野よるが「作家人生の原点」と語る",
    whyRead:
      "砂漠に不時着した「僕」が小さな王子との対話の中で気づく「かんじんなことは、目に見えない」という一節は、70年以上世界で読み継がれてきた。住野よるはこの本を、自身のデビュー作を含む最初の2作品にまで影響を残した特別な一冊として語っている。",
    recommenderStory:
