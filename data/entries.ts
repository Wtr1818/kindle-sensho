...
export const entries: Entry[] = [
  ...
  },
  {
    ...
    contentType: "本",
    genre: "小説",
    hook: "EXOのKaiがお気に入りに挙げる、直木賞受賞の本格ミステリー",
    whyRead:
      "天才数学者が仕掛ける完全犯罪と、旧友の物理学者・湯川学が挑む頭脳戦。累計290万部を突破し、映画化もされた「ガリレオ」シリーズの金字塔的長編。",
    recommenderStory:
  ...
  },
  {
    ...
    contentType: "本",
    genre: "古典",
    hook: "小説家・住野よるが「最初に読んだ小説」として挙げる、世界中で読み継がれる名作",
    whyRead:
      "砂漠に不時着した「僕」が出会った小さな王子との対話を通して、「本当に大切なものは目に見えない」ことを静かに問いかける、70年以上読み継がれる世界的名作。",
    recommenderStory:
