...
export const entries: Entry[] = [
  ...
  },
  {
    ...
    contentType: "本",
    genre: "自己啓発",
    hook: "「この本を丸ごと暗誦できる」──23個の金メダルを持つ競泳の神様マイケル・フェルプスが次世代アスリートに伝えた「今この瞬間に在る」という教え",
    whyRead:
    ...
    detailedStory:
      "マイケル・フェルプスが本書を初めて手にしたのは現役時代のことで、その後「本を丸ごと暗誦できる」と語るほど深く読み込んでいった。2016年リオ五輪でカナダの10代スプリンターとして脚光を浴びたペニー・オレクシアクと大会期間中に言葉を交わした際、フェルプスは彼女にこの本を薦めたという。世界一のプレッシャーがかかる舞台で「今この瞬間」に意識を向け続けることの難しさと大切さを、フェルプスは本書を通じて次世代に伝えようとしていた。フェルプスが繰り返し語ってきた「過去でも未来でもなく、今に集中する」という言葉は、本書の核心そのものだ。",
    recommenderName: "マイケル・フェルプス（競泳選手）",
    recommenderTag: "スポーツ選手",
    sourceLabel:
      "SwimSwam・CBCほか複数メディア（2020年）でペニー・オレクシアクに薦めた一冊として紹介。「本を丸ごと暗誦できる」と語る",
  ...
  },
  {
    ...
    contentType: "本",
    genre: "小説",
    hook: "K-POPグループEXOのKaiが選んだ、直木賞受賞のミステリー最高傑作",
    whyRead:
      "天才数学者が仕掛ける完全犯罪に、旧友の物理学者・湯川学が挑む頭脳戦。東野圭吾の代表作として累計290万部を突破し、映画化もされた「ガリレオ」シリーズ随一の傑作を、Kaiは自身のお気に入りの一冊に挙げている。",
    recommenderStory:
  ...
  },
  {
    ...
    contentType: "本",
    genre: "小説",
    hook: "有村架純が「23歳で読んだ衝撃を超える本がまだ見つからない」と語った、姉弟のように育った二人が堕ちていく愛の物語",
    whyRead:
  ...
  },
  {
    ...
    recommenderName: "Sundar Pichai（Google/Alphabet CEO、米国／インド出身）",
    recommenderTag: "経営者・起業家",
    sourceLabel:
